...
export const generateRoomDesign = async (prompt, imageUrl) => {
  ...
  const generated = result.data.generated;
  const bflUrl = generated[0].image?.url || generated[0].url || generated[0];

  // ✅ immediately upload to Cloudinary before BFL URL expires
  const uploaded = await uploadToCloudinary(bflUrl);
